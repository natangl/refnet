...
#ifndef REFNET_TEST_SCRIPTNUM10_H
#define REFNET_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Refnet Core 0.10.0, for cross-comparison.
 */
public:
