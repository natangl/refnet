...
#ifndef REFNET_WALLET_WALLET_H
#define REFNET_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! refnet from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Refnet Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this refnet node, and set to 0 for transactions that were created
