// Copyright (c) 2018-2019 The Refnet Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef REFNET_INTERFACES_CHAIN_H
#define REFNET_INTERFACES_CHAIN_H
...
//! internal workings of the refnet node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/refnet/refnet/pull/10973#issuecomment-380101269).
//!
//! * The relayTransactions() and submitToMemoryPool() methods could be replaced
//!   with a higher-level broadcastTransaction method
//!   (https://github.com/refnet/refnet/pull/14978#issuecomment-459373984).
//!
//! * The initMessages() and loadWallet() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/refnet/refnet/pull/15288#discussion_r253321096).
//!
...
#endif // REFNET_INTERFACES_CHAIN_H
