...
//! Entry point for RefnetApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &RefnetApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for RefnetGUI tests.
void AppTests::guiTests(RefnetGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &RefnetGUI::consoleShown, this, &AppTests::consoleTests);
