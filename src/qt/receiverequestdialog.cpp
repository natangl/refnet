...
#include <config/refnet-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRefnetURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RefnetUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRefnetURI(info));
}
