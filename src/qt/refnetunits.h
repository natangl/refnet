...
#ifndef REFNET_QT_REFNETUNITS_H
#define REFNET_QT_REFNETUNITS_H
...
/** Refnet unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RefnetUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RefnetUnits(QObject *parent);

    /** Refnet units.
      @note Source: https://en.refnet.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RFN,
...
typedef RefnetUnits::Unit RefnetUnit;

#endif // REFNET_QT_REFNETUNITS_H
