...
#ifndef REFNET_QT_SPLASHSCREEN_H
#define REFNET_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Refnet Core initialization
...
#endif // REFNET_QT_SPLASHSCREEN_H
