    ...
    platformStyle(_platformStyle)
{
    ...
    // normal refnet address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying refnet address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &RefnetAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
