    ...
    mapper(nullptr)
{
    ...
    ui->refnetAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->refnetAtStartup);
    ...
    ui->refnetAtStartup->setToolTip(ui->refnetAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->refnetAtStartup->setText(ui->refnetAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openRefnetConfButton->setToolTip(ui->openRefnetConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new RefnetUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->refnetAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openRefnetConfButton_clicked()
{
