...
#ifndef REFNET_TXMEMPOOL_H
#define REFNET_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/refnet/refnet/pull/14193 will fix it. No known code
     * in refnet currently depends on second guarantee, but it is important to
