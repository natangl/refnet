...
By default, refnetd will dump mempool on shutdown and
...
class MempoolPersistTest(RefnetTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent refnetd from writing mempool.dat to disk. Verify that `savemempool` fails")
