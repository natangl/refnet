...
"""Verify that starting refnet with -h works as expected."""

from test_framework.test_framework import RefnetTestFramework
from test_framework.util import assert_equal

class HelpTest(RefnetTestFramework):
    ...
    def run_test(self):
        self.log.info("Start refnet with -h for help text")
        ...
        self.log.info("Start refnet with -version for version information")
        ...
        self.log.info("Start refnetd with -fakearg to make sure it does not start")
