*After branching off for a major version release of Refnet Core, use this
...
https://github.com/refnet-core/refnet-devwiki/wiki/
...
Refnet Core version *version* is now available from:

  <https://refnetcore.org/bin/refnet-core-*version*/>
...
Upgrading directly from a version of Refnet Core that has reached its EOL is
possible, but might take some time if the datadir needs to be migrated.  Old
wallet versions of Refnet Core are generally supported.
...
Refnet Core is supported and extensively tested on operating systems using
the Linux kernel, macOS 10.10+, and Windows 7 and newer.  It is not recommended
to use Refnet Core on unsupported systems.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/refnet/refnet/).
