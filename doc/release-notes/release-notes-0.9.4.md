Refnet Core version 0.9.4 is now available from:

  https://refnet.org/bin/0.9.4/
...
this update is incompatible with the Refnet system and could lead to consensus
forks.

Refnet Core released binaries from https://refnet.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~refnet/+archive/ubuntu/refnet
- A third-party or self-compiled Refnet Core

upgrade to Refnet Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
