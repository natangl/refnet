Refnet Core version 0.16.1 is now available from:

  <https://refnetcore.org/bin/refnet-core-0.16.1/>
...
- #12843 `df38b13` Test starting refnetd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure refnetd processes are cleaned up when tests end (sdaftuar)
