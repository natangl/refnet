Refnet-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/refnet/files/Refnet/refnet-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Refnet
...
New/changed settings (command-line or refnet.conf file)
--------------------------------------------------------
