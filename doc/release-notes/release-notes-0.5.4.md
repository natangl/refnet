Refnet version 0.5.4 is now available for download at:
http://sourceforge.net/projects/refnet/files/Refnet/refnet-0.5.4/
...
http://gitorious.org/refnet/refnetd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Refnet-Qt notifications under Growl 1.3.
Increase required age of Refnet-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRefnet properly when installing Refnet-Qt over it. (Windows)
