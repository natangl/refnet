Refnet Core version 0.10.2 is now available from:

  <https://refnet.org/bin/refnet-core-0.10.2/>
...
characters (https://github.com/refnet/refnet/issues/6078).

For other platforms there are no notable changes.

For the notable changes in 0.10, refer to the release notes
at https://github.com/refnet/refnet/blob/v0.10.0/doc/release-notes.md
