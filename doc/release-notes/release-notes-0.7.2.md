Refnet version 0.7.2 is now available from:
  http://sourceforge.net/projects/refnet/files/Refnet/refnet-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Refnet-Qt to crash on Windows when exiting.
