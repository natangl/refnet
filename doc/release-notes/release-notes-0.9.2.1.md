Refnet Core version 0.9.2.1 is now available from:

  https://refnet.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RFN to 0.01 RFN
...
- Fix "Start refnet on system login"
