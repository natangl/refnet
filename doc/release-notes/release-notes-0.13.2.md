Refnet Core version 0.13.2 is now available from:

  <https://refnet.org/bin/refnet-core-0.13.2/>
...
- #8908 `4a974b2` Update refnet-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow refnet-tx to create v2 transactions (RFNdrak)
