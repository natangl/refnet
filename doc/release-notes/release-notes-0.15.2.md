Refnet Core version *0.15.2* is now available from:

  <https://refnetcore.org/bin/refnet-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in refnet-tx (TheBlueMatt)
