Refnet Core version 0.11.2 is now available from:

  <https://refnet.org/bin/refnet-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include refnet-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split refnet-tx into its own package
