Download URL: https://sourceforge.net/projects/refnet/files/Refnet/refnet-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RFN fee schedule (users still pay 0.01 RFN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #refnet00 - #refnet99
